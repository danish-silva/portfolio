---
title: Separately Excited DC Motor Drive Simulation
...
# endDate:
# ongoing: false
# Allowed tags: embedded, robotics, pcb, mechanical, controls, machine-learning
# tags: []
# tools: []
# links:
#   - label: Source code
...
#     caption: ""
# video:
#   src: /media/dc-motor-drive-simulation/demo.mp4   # or an external URL
...
<!-- TODO: Enough detail that an engineer can tell it was real. Model equations, integration step, how soft start, field weakening and regenerative braking were implemented. -->
